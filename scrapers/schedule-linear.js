...
var _getNextPage = function(driver) {
    return when.promise(function(resolve) {
        setTimeout(function () {
            driver.findElement(By.css('.schedule-wrapper'))
                    .findElements(By.tagName('div'))
...
var _getAllPrograms = function(url) {
    return when.promise(function(resolve) {
        ...
        //One next link
        _getOneNextLink(allPrograms, driver).then(function(programs) {
            //For previous 10 links
            resolve(_getAllPrevLinks(programs, driver, 0));
        });
    });
};
...
var _getOneNextLink = function(allPrograms, driver) {
    return when.promise(function(resolve) {
        setTimeout(function() {
            _getNextPage(driver).then(function(driver) {
                allPrograms.push(_getAllProgramsOnPage(driver));
                resolve(allPrograms);
            });
        }, 2000);
